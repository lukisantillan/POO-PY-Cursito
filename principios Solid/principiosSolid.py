"""
Mantenibilidad: debe ser facil de mantener y modificar en el tiempo
Reusabilidad: todos los compenentes deben ser reutilizables
Legibilidad: facil y claro de leer
Extensible: debe poder extenderse sin afectar al codigo anterior.
